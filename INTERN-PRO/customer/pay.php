...
$query = mysqli_query($con, "SELECT * FROM cart WHERE userid = $userid");
...
while ($cartItem = mysqli_fetch_assoc($query)) {
    ...
    mysqli_query($con, "INSERT INTO orders (userid, pid) VALUES ($userid, $pid)");
}

    mysqli_query($con,"delete from cart where pid=$pid");
